...
public managerOnly {Request memory newRequest = Request({
...
function approveRequest(uint requestId) public supporterOnly {Request storage request = requests[requestId];
